...
public class CheckSecond extends AppCompatActivity {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        Toast.makeText(CheckSecond.this,titleasg[position],Toast.LENGTH_SHORT).show();

                        String value = titleasg[position];
                        Intent intent = new Intent(CheckSecond.this, MarksListSecond.class);
