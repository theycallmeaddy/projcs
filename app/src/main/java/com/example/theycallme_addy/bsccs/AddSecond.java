...
public class AddSecond extends AppCompatActivity {
    ...
    private void sendAssignment(){
        ...
        DatabaseReference myRef = firebaseDatabase.getReference().child("Assignment Second Year").child(title);
        ...
        Toast.makeText(AddSecond.this,"Assignment Added Successfully" ,Toast.LENGTH_SHORT).show();
    }
...
//    }
    ...
    private Boolean validate(){
        ...
        if(title.isEmpty() || sdate.isEmpty() || question.isEmpty() || smonth.isEmpty() || syear.isEmpty()){
            Toast.makeText(AddSecond.this,"Please Fill All Columns",Toast.LENGTH_SHORT).show();
            if(sDateInt>=32 || sMonthInt>=13 || sYearInt>=10000);{
                Toast.makeText(AddSecond.this,"Invalid Date",Toast.LENGTH_SHORT).show();
