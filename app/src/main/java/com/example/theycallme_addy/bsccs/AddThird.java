...
public class AddThird extends AppCompatActivity {
    ...
    private void sendAssignment(){
        ...
        DatabaseReference myRef = firebaseDatabase.getReference().child("Assignment Third Year").child(title);
        ...
        Toast.makeText(AddThird.this,"Assignment Added Successfully" ,Toast.LENGTH_SHORT).show();
    }
    ...
    private Boolean validate(){
        ...
        if(title.isEmpty() || sdate.isEmpty() || question.isEmpty() || smonth.isEmpty() || syear.isEmpty()){
            Toast.makeText(AddThird.this,"Please Fill All Columns",Toast.LENGTH_SHORT).show();
            if(sDateInt>=32 || sMonthInt>=13 || sYearInt>=10000);{
                Toast.makeText(AddThird.this,"Invalid Date",Toast.LENGTH_SHORT).show();
