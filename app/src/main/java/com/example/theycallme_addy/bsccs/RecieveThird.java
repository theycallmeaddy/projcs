...
public class RecieveThird extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recieve_third);
        ...
        DatabaseReference databaseReference = firebaseDatabase.getReference().child("Assignment Third Year").child(value);
    ...
    private void sendAssignmentAns(){
        ...
        DatabaseReference myRef = firebaseDatabase.getReference().child("Assignment Third Year Answers").child(value).child(firebaseAuth.getUid());
        ...
        Toast.makeText(RecieveThird.this,"Assignment Submitted Successfully" ,Toast.LENGTH_SHORT).show();
    }
    ...
    private Boolean validate(){
        ...
        if(answer.isEmpty()){
            Toast.makeText(RecieveThird.this,"I Like Your Confidence! Now Type the Answers",Toast.LENGTH_SHORT).show();
        }
        else{
            result = true;
        }
