...
public class AssessmentThird extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_assessment_third);
        ...
        DatabaseReference databaseReference1 = firebaseDatabase.getReference().child("Assignment Third Year Answers").child(value).child(uid);
        databaseReference1 .addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                try {
                    ...
                    Toast.makeText(AssessmentThird.this,"Answers not Submitted yet",Toast.LENGTH_SHORT).show();
