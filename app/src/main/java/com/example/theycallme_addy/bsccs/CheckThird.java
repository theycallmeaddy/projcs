...
public class CheckThird extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_check_third);
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        Toast.makeText(CheckThird.this,titleasg[position],Toast.LENGTH_SHORT).show();

                        String value = titleasg[position];
                        Intent intent = new Intent(CheckThird.this, MarksListThird.class);
